...
export default function CreatePurchaseOrderPage() {
    ...
    const [savedPO, setSavedPO] = useState<any | null>(null);
            ...
            <div className="max-w-4xl mx-auto py-12 print:py-0 print:my-0 print:max-w-full">
                ...
                <div className="bg-white border shadow-sm print:shadow-none print:border-none p-12 print:p-0 relative">
                    <QuotePrintTemplate
                        ...
                        status="Pending"
                        createdAt={savedPO.createdAt.toISOString()}
                                ...
                                <tbody className="divide-y divide-zinc-100">
                                    {items.map((item, idx) => (
                                        <tr key={item.id} className="group relative">
                                            ...
                                            <td className="px-6 py-4">
                                                {items.length > 1 && (
                                                    <button type="button" onClick={() => setItems(items.filter(i => i.id !== item.id))} className="text-zinc-300 hover:text-red-500 p-1">
                                                        ✖
                                                    </button>
                                                )}
                                            </td>
