    ...
    const handleSelectOrder = (order: TableOrder) => {
        ...
        setEditableItems(order.items.map(item => {
            ...
            return {
                ...
                room: (item as any).room || 'General',
                unit: (item as any).unit || 'sqft',
            };
        }));
                            ...
                            <div className="bg-zinc-900 text-white p-6 flex justify-between items-center">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="text-left">
                                        ...
                                        <p className="text-xs text-zinc-400 mt-0.5">Select a layout format for Quote #{selectedOrder.orderNumber?.toString().padStart(4, '0') || selectedOrder.id.slice(0, 8)}</p>
                                    </div>
                                </div>
