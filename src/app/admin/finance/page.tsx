...
export default function FinanceDashboard() {
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 px-1 sm:px-0">
                ...
                <div className="bg-white border border-zinc-200 rounded-xl p-6 shadow-sm">
                    <div className="text-sm font-medium text-amber-600 mb-1">Commissions & Credits</div>
                    <div className="text-3xl font-bold text-amber-700">${(finance.totalCommissions || 0).toLocaleString(undefined, { minimumFractionDigits: 2 })}</div>
                </div>
                <div className="bg-emerald-50 border border-emerald-100 rounded-xl p-6 shadow-sm">
                    ...
                    <div className="text-xs text-emerald-700/70 mt-2 font-medium">Margin: {finance.totalRevenue > 0 ? ((finance.netProfit / finance.totalRevenue) * 100).toFixed(1) : "0"}%</div>
                </div>
            </div>
